...
struct Fader_Previews: PreviewProvider {
    ...
    TrackControl(viewModel: TrackControlViewModel(track: Track(id: UUID(), name: "Click", relativePath: String.empty, config: .init(pan: 0, volume: 0.5, isMuted: false), order: 0)))
